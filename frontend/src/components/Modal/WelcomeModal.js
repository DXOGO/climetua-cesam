            ...
            <div className="welcome-modal-content">
                ...
                <div className="welcome-modal-info">
                    ...
                    <p className="welcome-modal-small">
                        Os dados de teste usados para esta prova de conceito pertencem ao intervalo de tempo de 7 julho 2021 às 00:00:00 até 15 julho 2021 às 12:00:00 e, no que toca a variáveis disponíveis para cada cidade de distrito, inclui os seguintes: temperatura, humidade relativa, nebulosidade, precipitação total, precipitação convenctiva, precipitação não convenctiva, pressão, velocidade do vento e direção do vento.
                    </p>
                </div>
